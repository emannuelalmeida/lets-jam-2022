...
#region Connections
	...
	public void _on_PlayerRange_body_entered(Node body)
	{
	...
	public void _on_PlayerRange_body_exited(Node body)
	{
		if(body.IsInGroup("Player"))
		{
			player = null;
	...
	public void _on_InAttackRange_body_entered(Node body)
	{
		if(body.IsInGroup("Player"))
		{
	...
	public void _on_InAttackRange_body_exited(Node body)
	{
		if(body.IsInGroup("Player"))
		{
